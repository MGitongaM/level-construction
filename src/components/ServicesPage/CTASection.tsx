        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
            <div className="flex flex-wrap-reverse md:flex-nowrap justify-between items-center gap-8 border border-teal-600 rounded-md">
                <div className="w-full md:w-5/12 space-y-6 pl-10">
                    ...
                    <p className="">Let’s bring your vision to life with expert consultation and tailored solutions that deliver real impact</p>
                ...
                <div className="w-full md:w-6/12 h-80 bg-teal-600 md:rounded-r-md">
